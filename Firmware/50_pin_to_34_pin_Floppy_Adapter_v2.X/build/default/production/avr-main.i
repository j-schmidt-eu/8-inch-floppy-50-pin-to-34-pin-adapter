...
__asm("\tpsect eeprom_data,class=EEDATA,noexec"); __asm("\tdb\t" "0" "," "76" "," "0" "," "0" "," "44" "," "99" "," "76" "," "0");
__asm("\tpsect eeprom_data,class=EEDATA,noexec"); __asm("\tdb\t" "0" "," "44" "," "99" "," "0" "," "0" "," "0" "," "0" "," "0");
...
int main(void)
{
    ...
    driveParams_A.headLoadMode = HL_FromMotorEnable;
    driveParams_A.tgXXMode = TG_UseThresholds;
    ...
    driveParams_B.headLoadMode = HL_FromMotorEnable;
    driveParams_B.tgXXMode = TG_UseThresholds;
        ...
        if (!PORTBbits.RB0 || !PORTBbits.RB2)
        {
...

            {
                ...
                case HL_FromMotorEnable:
                    if(!PORTBbits.RB0)
                        headLoad = !PORTBbits.RB1;
                    else
                        headLoad = !PORTAbits.RA2;
                    break;
                        ...
                        if (menuMode != M_Hidden)
                        {
                            ...
                            else
                            {
                                ...
                                case M_MaxTrack_A:
                                    ...
                                    break;
                                case M_TGXX_A:
                                    if(driveParams_A.tgXXMode == TG_FromExternalSignal)
                                        driveParams_A.tgXXMode = TG_UseThresholds;
                                    else
                                        driveParams_A.tgXXMode++;
                                    break;
                                case M_HeadLoad_A:
                                    if(driveParams_A.headLoadMode == HL_FromExternalSignal)
                                        driveParams_A.headLoadMode = HL_FromMotorEnable;
                                    else
                                ...
                                case M_MaxTrack_B:
                                    ...
                                    break;
                                case M_TGXX_B:
                                    if(driveParams_B.tgXXMode == TG_FromExternalSignal)
                                        driveParams_B.tgXXMode = TG_UseThresholds;
                                    else
                                        driveParams_B.tgXXMode++;
                                    break;
                                case M_HeadLoad_B:
                                    if(driveParams_B.headLoadMode == HL_FromExternalSignal)
                                        driveParams_B.headLoadMode = HL_FromMotorEnable;
                                    else
...
void __attribute__((picinterrupt(("low_priority")))) isrLowPrio(void)
{
    ...
    if (PIR4bits.CCP3IF)
    {
        ...
        if ((!PORTBbits.RB0 || !PORTBbits.RB2) && !PORTBbits.RB5)
        {
            TMR2 = 0;
...
void __attribute__((picinterrupt(("high_priority")))) isrHighPrio(void)
{
    ...
    if (PIR4bits.CCP5IF)
    {
        ...
        if(!PORTBbits.RB0 || !PORTBbits.RB2)
        {
            ...
            if (!PORTAbits.RA4 && PORTAbits.RA0)
            {
                if (!PORTAbits.RA3)
                {
